...
#include <AP_RangeFinder/my.h>     // Range finder library
...
private:
    ...
    int32_t nav_roll_cd;
    int32_t demanded_roll_new;
    int32_t demanded_roll_old;

    //console窗口调试打印数据使用 例如：
    // tm = AP_HAL::millis();
    // if(tm - last_tm >1000){
    //     hal.console -> printf("%d",nav_roll_cd);
    //     last_tm = tm;
    // }
    uint32_t last_tm = 0;
    uint32_t tm;
    ...
    int32_t demanded_pitch_new;
    int32_t demanded_pitch_old;
